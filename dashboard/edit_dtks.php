...
<div class="wrapper">
 ...
 <?php
    include 'koneksi.php';
      ...
      $query = "SELECT * FROM dtks WHERE id=?";
    ...
    <form method="POST" action="edit_dtks_action.php">
      <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="container-fluid">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
            <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" value="<?php echo $tgl_lahir; ?>" required="true">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <a href="dtks.php"><button type="button" class="btn btn-danger" title="Kembali">
            Kembali</button></a>
          </td>
            </div>
          </div>
