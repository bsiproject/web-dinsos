...
<div class="wrapper">
 ...
 <?php
    include 'koneksi.php';
      ...
      $query = "SELECT * FROM bpjs WHERE id=?";
      ...
      <div class="card-body">
          <div class="form-group">
           ...
           <div class="form-group">
            <label>KK</label><br>
            <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
            <img src="user/upload/<?php echo $kk; ?>" width="400" height="400">
          </div>
           <div class="form-group">
            <label>KTP</label><br>
            <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
            <img src="user/upload/<?php echo $ktp; ?>" width="400" height="400">
          </div>
          <div class="form-group">
            <label>SKTM</label><br>
            <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
            <img src="user/upload/<?php echo $sktm; ?>" width="400" height="400">
          </div>
            <td>
            <a href="bpjs.php"><button type="button" class="btn btn-danger" title="Kembali">Kembali</button></a>
          </td>
            </div>
          </div>
        </div>
