        ...
        <section class="container-fluid mb-4">
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    <h4 class="text-center font-weight-bold"> Silahkan Daftar</h4>
                    <?php if($error != ''){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="InputRePassword" name="repassword" placeholder="Ulangi-Password">
                        <?php if($validate != '') {?>
                            <p class="text-danger"><?= $validate; ?></p>
                        <?php }?>
                    </div>
                    ...
                    <div class="form-footer mt-2">
                        <p> Sudah punya akun? <a href="login.php">Silahkan Login</a>- <a href="http://localhost/webdinsos/">Home</a></p>
                    </div>
                </form>
            </section>
            </section>
