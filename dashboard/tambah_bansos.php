...
?>
    <!-- Main content -->
    <form method="POST" action="tambah_bansos_action.php" enctype="multipart/form-data">
      <div class="content-header"> 
      <div class="container-fluid">
        <div class="row">
          <div class="col-md">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="id" id="id">
            <input type="date" name="tgl_penerima" id="tgl_penerima" class="form-control" required="true">
          </div>
      ...
      <div class="form-group">
            ...
            <a href="bansos.php"><button type="button" class="btn btn-danger" title="Kembali">Kembali</button></a>
            </button>
          </div>
            </div>
          </div>
