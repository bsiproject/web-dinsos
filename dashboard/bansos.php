		 ...
		 <table class="table-responsive">
    	  <table class="table table-bordered table-hover table-striped" id="dataTables-example">
	    	...
	    	<tbody>
				...
				include 'koneksi.php';
			        $no = 1;
			        $query = "SELECT * FROM bansos ORDER BY id DESC";
            ...
            <td><?php echo $tgl_penerima; ?></td>
						<td>
							<!-- base64_encode berguna untuk enkripsi id jadi nanti akan mengubah urlnya menjadi tulisan acak -->
							<a href="edit_bansos.php?aa=<?php echo base64_encode($id) ?>">
								<button class="btn btn-success btn-sm"> Edit </button>
							</a>
              <a href="cetak_bansos.php?aa=<?php echo base64_encode($id) ?>">
                <button class="btn btn-warning btn-sm"> Cetak </button>
              </a>
							<a href="hapus_bansos.php?aa=<?php echo base64_encode($id) ?>">
