...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand" href="index.html"><img src="images/logo.png" width="50" alt="alternative"></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a><i class="fa fa-angle-double-right"></i><span>Visi & Misi</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container dark">
                        <h3>VISI :</h3>
                        <p>Terwujudnya efektivitas penanganan masalah kesejahteraan social dan bencana yang didukung oleh meningkatnya pemberdayaan masyarakat dan desa..</p>
                        <h3>MISI :</h3>
                        <ul class="list-unstyled li-space-lg indent">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Meningkatkan kerja aparatur dinas sosial, pemberdayaan masyarakat dan desa</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Membangun kemitraan dan kerja sama yang harmonis dengan lembaga sosial</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Mengembangkan prakarsa dan peran aktif masyarakat dalam meningkatkan kemandirian penyandang masalah kesejahteraan sosial</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Perwujudtan masyarakat sosial dan lembaga sosial yang berkualitas dan bermartabat</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Penanganan bencana yang tanggap, cepat, tepat.</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Mengembangkan ekonomi masyarakat kerakyatan dan mendayagunakan potensi masyarakat melalui pemanfaatan dan pelestarian sarana dan prasarana serta transpormatasi dan pemanfaatan teknologi tepat guna</div>
                            </li>
                             <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Meningkatkan pengembangan sumber daya manusia masyarakat pemantapan pemerintah desa dan kelurahan dalam rangka pemberdayaan dan penguatan otonomi daerah</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Meningkatkan sumber daya dan mengoptimalkan fungsi-fungsi pemerintah dalam rangka meningkatkan tata kelola pemerintahan desa/kelurahan yang baik dan bersih</div>
                            </li>
                        </ul>
    ...
    <div class="ex-basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Visi & Misi</span>
                    </div> <!-- end of breadcrumbs -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-md-3">
                    <div class="footer-col second">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><a href="index.html">Home</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><a href="index.html#contact">Kontak</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
