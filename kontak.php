...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="white">Halaman Kontak</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a><i class="fa fa-angle-double-right"></i><span>Halaman Kontak</span>
                    ...
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Area Kantor Bupati Kabupaten Kuantan Singingi</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-mobile-alt"></i>
                                <div class="media-body">+62 813 7811 4287</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-envelope"></i>
                                <div class="media-body"><a class="light-gray" href="mailto:contact@zigo.com">dinsos_kuansing@gmail.com</a></div>
                            </li>
                        </ul>
                ...
                <?php
                  ...
                  ?>
                     ...
                     <div class="contact-us">
                        <form method="POST" action="kirimdata.php" class="comments-form" id="contactform">
                           <ul>
                           <div class="card-body">   
                           ...
                           <div class="form-group">
                              <input type="hidden" name="id" id="id">
                              <input type="text" name="email" id="email" class="form-control" placeholder="Masukkan Email" required="true">
                           </div>

                           <div class="form-group">
                              <input type="hidden" name="id" id="id">
                              <input type="text" name="pesan" id="pesan" class="form-control" placeholder="Masukkan Pesan Anda" required="true">
                           </div>

                           <div class="form-group">
                              <button type="submit" name="simpan" id="simpan" class="btn btn-success">
                                <i class="fa fa-send" title="Kirim" value="<?php echo $kontak; ?>" required="true"></i> Kirim
                              </button>
                           </div>
                           </ul>
